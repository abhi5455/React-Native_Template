    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-100">
            <ScrollView className="flex-1 bg-gray-100">
                <View
                    className="h-[250px] rounded-b-2xl overflow-hidden">
                    <LinearGradient
                        colors={['#164e63', '#0891b2', '#06b6d4']}
                        className="h-[250px] items-center justify-center rounded-b-[30px]"
                    >
                        <View
                            className="flex items-center justify-center bg-cyan-100 rounded-full h-20 w-20">
                            <Text
                                className="text-cyan-600 font-semibold text-xl">JD</Text>
                        </View>
